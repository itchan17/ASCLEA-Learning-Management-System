...
const Step6 = () => {
  console.log("Render Registration Step 6");
  ...
  return (
    <div className="mx-auto max-w-4xl border-[2px] border-ascend-gray1 bg-white p-10 shadow-lg">
      <h3 className="text-size3 mb-4 font-nunito-sans text-left text-black">Enrollment Policy</h3>
      ...
      <div className="flex items-center space-x-3 mb-4">
        <input type="checkbox" checked={registration.checked1 === true} onChange={(e) => handleRegistrationChange("checked1", e.target.checked ? true: false)} className="w-3 h-3 rounded-full border border-ascend-gray1 " />
        <label className="text-size2">I acknowledge and agree to the enrollment policy</label>
      </div>  
     
      <h3 className="text-size3 mb-4 font-nunito-sans font-bold text-left text-black">Enrollment Terms and Condition</h3>
      <div className="text-size1 mb-4 text-left text-black leading-relaxed space-y-2">
        ...
        <div className="flex items-center space-x-3 mb-4">
            <input type="checkbox" checked={registration.checked2 === true} onChange={(e) => handleRegistrationChange("checked2", e.target.checked ? true: false)} className="w-3 h-3 rounded-full border border-ascend-gray1 " />
