          ...
          >
            ...
            <tr>
              <td class="email-masthead">
                  <img src="{{ $message->embed(public_path('images/ascend_logo.png')) }}" alt="ASCEND Logo">
              </td>
            </tr>
            <!-- Email Body -->
            <tr>
                ...
                >
                  ...
                  <tr>
                    <td class="content-cell">
                      ...
                      <p>
                        Welcome to the Asclea family!<br />
                        We're excited to have you on board. At Asclea, our goal
                          ...
                          <td align="center">
                            <div>
                              <a
                                ...
                                style="display: inline-block; width: 200px; background-color: #01007d; color: #ffffff; font-size: 15px; line-height: 45px; text-align: center; text-decoration: none; -webkit-text-size-adjust: none;"
                              >
                                Verify Email
                              </a>                   
                            </div>
                  ...
                  <tr>
                    <td class="content-cell">
                      <p class="sub center">
                        ...
                        <br />611 JPRizal Boulevard, Brgy. Labas, City of Santa
                        Rosa, Laguna
                      </p>
                    </td>
                  </tr>
