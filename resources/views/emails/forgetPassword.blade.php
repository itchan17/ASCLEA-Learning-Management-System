      ...
      <tr>
        <td align="center">
          ...
          >
            <!-- Logo -->
            <tr>
              <td class="email-masthead" align="center" style="padding: 25px 0">
                <img
                  src="{{ $message->embed(public_path('images/ascend_logo.png')) }}"
                  alt="Asclea Logo"
                  width="150"
                />
              </td>
                ...
                >
                  <tr>
                    <td class="content-cell">
                      ...
                      <p>
                        You’re receiving this email because we received a
                        password reset request for your Asclea account.
                      </p>
                      ...
                      <p style="margin-top: 30px">
                        If you didn’t request a password reset, no further
                        action is required.
                      </p>
                    </td>
                  </tr>
