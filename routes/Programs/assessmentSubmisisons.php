...
Route::prefix('courses/{course}/assessments/{assessment}/')
    ...
    ->group(function () {
        ...
        Route::post('quizzes/{quiz}/assessment-submission/{assessmentSubmission}/validate', [AssessmentSubmissionController::class, 'validateRequiredQuestions'])->can('validateRequiredQuestion', ['assessmentSubmission', 'assessment', 'course'])->name('assessment.quiz.validate');
        ...
        Route::post('quizzes/{quiz}/assessment-submission/{assessmentSubmission}', [AssessmentSubmissionController::class, 'submitQuiz'])->can('submitQuiz', ['assessmentSubmission', 'assessment'])->name('quizzes.quiz.submit');

        // Route for showing the quiz result 
        Route::get('quizzes/{quiz}/assessment-submission/{assessmentSubmission}/result', [AssessmentSubmissionController::class, 'showQuizResult'])->can('viewQuizResult', ['assessmentSubmission', 'assessment', 'quiz'])->name('quizzes.quiz.result');

        // Route for showing the quiz result 
        Route::post('quizzes/{quiz}/assessment-submission/{assessmentSubmission}/result/ai/feedback', [AssessmentSubmissionController::class, 'quizResultFeedback'])->can('generateQuizResultFeedback', 'assessmentSubmission')->name('generate.quiz.result.feedback');
